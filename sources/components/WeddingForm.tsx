...
const RequiredTag = () => (
  <span className="border border-[#F99D8C] text-[#F99D8C] text-xs font-semibold px-2 py-0.5 rounded-sm">
    必須
  </span>
);

const OptionalTag = () => (
  <span className="border border-[#DDDDDD] text-gray-400 text-xs font-semibold px-2 py-0.5 rounded-sm">
    任意
  </span>
);
              ...
              {["groom", "bride"].map((type) => (
                <label
                  ...
                  className={`flex-1 flex items-center gap-3 px-6 py-3 border rounded-full cursor-pointer transition-colors ${
                    guestType === type ? "border-[#F99D8C]" : "border-[#DDDDDD]"
                  }`}
                >
                  <input
                    type="radio"
              ...
              >
                <span
                  className={`transform transition-transform duration-200 ${
                    companionsOpen ? "rotate-180" : "rotate-0"
                  }`}
                >
                  <Image
                ...
                <div key={i} className="mt-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <TextInput
                      ...
                      value={comp.furigana}
                      onChange={(e) =>
                        handleCompanionChange(i, "furigana", e.target.value)
                      }
                    />
                  </div>
                  <div className="mt-8">
                    <TextInput
                      ...
                      onChange={(e) =>
                        handleCompanionChange(i, "allergies", e.target.value)
                      }
                    />
                  </div>
                </div>
